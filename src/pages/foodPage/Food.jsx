                ...
                >
                  <div className="food_comfort__text ">
                    <h4 className="white__text">
                      Always eat on time. <br /> Or get paid for waiting.
                    </h4>
                    <p className="py-6">
                      We’ll deliver your food on time, every time. And if we
                      don’t, you get Gh2 cedis back for every extra minute you
                      wait. We mean it.
                    </p>
          ...
          <section className="slide__content-about">
            ...
            <div className="ride__content center__item">
              ...
              >
                <div>
                  <HText>
                    Order from 7000+ <br /> restaurants.
                  </HText>
                  <p className="py-6">
                    Whatever you’re craving, we’ve got it covered. Enjoy your
                    favourites, or find new ones. Order them all with a tap, all
                    on one app.
                  </p>
