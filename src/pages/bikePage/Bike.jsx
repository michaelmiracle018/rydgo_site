				...
				<div className="single__card-info drop-shadow-md">
					...
					<div className="card__info-text">
						<div>
							<h4>Join</h4>
							<p>
								Become an annual member or get a short-term pass through the
								Rydgo app.
							</p>
						</div>
					</div>
				...
				<div className="single__card-info drop-shadow-md">
					...
					<div className="card__info-text">
						<div>
							...
							<p>
								Download the Rydgo app, select Bike, and find a station. Unlock
								the bike by scanning the QR code, and you’re set!
								{isTimeText && (
									<div>
				...
				<div className="single__card-info drop-shadow-md">
					...
					<div className="card__info-text">
						<div>
							<h4>Return</h4>
							<p>
								Dock your bike at any Rydgo BIKE station; wait for the green
								light and buzzer sound to make sure it’s locked. ...
								{isReferralText && (
									<div>
							...
							<div className="ride_comfort__wrap">
								...
								>
									<div className="ride_comfort__text ">
										...
										<p className="py-6">
											Careem BIKE is perfect for quick trips. A few taps, and
											you’re off!
										</p>
							...
							<div className="ride_max__wrap">
								...
								>
									<div className="ride_max__text ">
										...
										<p className="py-6">
											Finding a station, renting a bike and paying is super
											simple.
										</p>
						...
						<div className="ride__content center__item">
							...
							>
								<div>
									...
									<p className="py-6">
										Rydgo BIKE is the most sustainable way to get where you’re
										going while getting exercise and having fun!
									</p>
									<RedButton>Ride now</RedButton>
								</div>
							</motion.div>
