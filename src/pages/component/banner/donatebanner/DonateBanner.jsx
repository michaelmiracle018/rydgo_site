...
const DonateBanner = () => {
	return (
		<section className="donatebanner__container">
			<div>
			<img src={DonateBannerImage} alt="donateImage" width={500} className="absolute"/>

			<div className="text relative pt-28 pl-40">
				<h3 className="text-6xl text-white italic font-bold flex justify-start">Kindness, <br/> in a ride.</h3>
