...
import "./rydsuperbanner.scss";
import RydSuperBannerImage from "../../../../assets/images/Rectangle15.png";

const RydSuperBanner = () => {
  return (
    <section className="rydsuperbanner__container">
      <div>
        <img
          src={RydSuperBannerImage}
          alt="rydsuperImage"
          width={500}
          className="absolute"
        />
