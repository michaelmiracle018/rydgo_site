...
const DineBanner = () => {
	return (
		<section className="ridebanner__container">
			<div>
			<img src={DineBannerImage} alt="rideImage" width={500} className="absolute"/>

			<div className="text relative pt-28 pl-40">
				<h3 className="text-6xl text-white italic font-bold flex justify-start">Discover, <br/> Ghana's finest<br/>Restaurant</h3>
